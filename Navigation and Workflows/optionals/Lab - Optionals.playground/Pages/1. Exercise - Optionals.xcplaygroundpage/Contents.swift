...
print(userAge)
//it happens so because userAge has type optional Int which means that if there is not an integer value it will print nil since userinputage has 34e in string which cannot be convertted to int
/*:
